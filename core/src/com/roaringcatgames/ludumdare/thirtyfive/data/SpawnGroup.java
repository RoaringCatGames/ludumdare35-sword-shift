...
public class SpawnGroup {
    ...
    private static SpawnBatch generateBatch(float xPos, float baseXOffset, EnemyType eType, Formation formation){
        ...
        switch(formation){
            case THREE_EVEN:
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset, 7.5f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset, 3.75f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset, 11.25f));
                break;
            case STAR:
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset, 3.75f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset, 11.25f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset + 2f, 7.5f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset + 4f, 3.75f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset + 4f, 11.25f));
                break;
            case PYRAMID:
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset, 7.5f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset, 3.75f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset, 11.25f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset + 2f, 10f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset + 2f, 5f));
                batch.enemyDefs.add(new EnemyDefinition(eType, baseXOffset + 4f, 7.5f));
                break;
        }
